...
USER_POLYGON_COORDS = [
    [-118.280182, 34.164091],
    [-118.314514, 34.059486],
    [-118.138733, 34.008273],
    [-118.134613, 34.155],
    [-118.280182, 34.164091]
]
...
# ── UI Export paths ───────────────────────────────────────────────────────────
OUTPUT_STATIONS    = '../outputs/beats/stations.csv'
OUTPUT_INCIDENTS   = '../outputs/beats/incidents_export.csv'
OUTPUT_OPT_SUMMARY = '../outputs/beats/optimization_summary.csv'
OUTPUT_BEATS_GEO   = '../outputs/beats/beat_polygons.geojson'

IP_TIME_LIMIT = 1800     # CBC time limit in seconds (0 = no limit)
IP_MIP_GAP    = 0.005    # Accept solution within 0.5% of LP bound.
                         # Your run showed 645,002 vs LP bound 645,056 (0.008% gap)
                         # so the solver will accept and exit almost immediately.
